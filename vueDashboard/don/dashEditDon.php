                ...
                <form method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="title" type="text" class="form-control" id="title" value="<?= $don->Title ?>">
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label for="category" class="col-md-4 col-lg-3 col-form-label">Categorie</label>
                        <div class="col-md-8 col-lg-9">
                            <select name="category" id="category">
                                <?php foreach ($categories as $cat) : ?>
                                    <option value="<?=  $cat->idcategorie; ?>"><?=  $cat->Title; ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
