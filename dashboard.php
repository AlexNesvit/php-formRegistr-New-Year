...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="vueDashboard/dashboardCategory.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="vueDashboard/dashboardDonation.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Tableau de bord</h1>
        <h2>Bonjour <?= $_SESSION['auth']->name; ?></h2>
